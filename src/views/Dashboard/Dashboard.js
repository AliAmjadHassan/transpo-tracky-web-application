  ...
  datasets: [
    {
      ...
      borderColor: "rgba(255,255,255,.55)",
      data: [100, 180, 70, 170, 140, 122, 111]
    }
  ]
};
  ...
  datasets: [
    {
      ...
      backgroundColor: brandInfo,
      borderColor: "rgba(255,255,255,.55)",
      data: [200, 150, 190, 110, 155, 100, 190]
    }
  ]
};
    ...
    yAxes: [
      {
        ...
        ticks: {
          display: false,
          min: Math.min.apply(Math, route1data.datasets[0].data) - 5,
          max: Math.max.apply(Math, route1data.datasets[0].data) + 5
        }
      }
    ]
  },
...
var elements = 27;
var data1 = [100, 180, 70, 170, 140, 122, 111];
var data2 = [200, 150, 190, 110, 155, 100, 190];
var data3 = [40, 200, 80, 160, 120, 90, 400];
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value">Route 1</div>
                <div>Muridke-Comsats</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Bar data={route1data} options={cardChartOpts4} height={70} />
              </div>
            </Card>
          </Col>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value">Route 2</div>
                <div>Shahdrah-Comsats</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Bar data={route2data} options={cardChartOpts4} height={70} />
              </div>
            </Card>
          </Col>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value">Route 3</div>
                <div>Station-Comsats</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Bar data={route3data} options={cardChartOpts4} height={70} />
              </div>
            </Card>
          </Col>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                ...
                <div className="text-value">Route 4</div>
                <div>Thokar-Comsats</div>
              </CardBody>
              <div className="chart-wrapper mx-3" style={{ height: "70px" }}>
                <Bar data={route1data} options={cardChartOpts4} height={70} />
              </div>
          ...
          <Col>
            <Card>
              <CardBody>
                <Row>
                  <Col sm="5">
                    <CardTitle className="mb-0">Passengers</CardTitle>
                    <div className="small text-muted">Fall 2020</div>
                  </Col>
